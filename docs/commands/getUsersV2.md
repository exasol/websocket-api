...
This command gets the specified users in the database.
...
| CONSUMER_GROUP | string | user consumer group |
...
Request fields:
  ...
  * command (string) => command name: "getUsers"
  ...
  * name (string, optional) => user name. "" means no user, null means all users.
